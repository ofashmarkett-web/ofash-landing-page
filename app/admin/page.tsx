      ...
      <div style={{ maxWidth:1120, margin:"0 auto", padding:"32px 20px 0" }}>
        ...
        {stats && (
          <>
            ...
            {/* ── Live Resend status banner ── */}
            {!stats.resendError && !stats.resendRateLimited && (
              <div style={{ padding:"9px 16px", borderRadius:10, background:"rgba(74,222,128,0.06)", border:"1px solid rgba(74,222,128,0.18)", marginBottom:20, fontSize:13, color:"#4ade80" }}>
                ✓ Live data from Resend — {stats.total} signup{stats.total !== 1 ? "s" : ""} across {stats.buyers} buyer{stats.buyers !== 1 ? "s" : ""}, {stats.vendors} vendor{stats.vendors !== 1 ? "s" : ""}, {stats.riders} rider{stats.riders !== 1 ? "s" : ""}.
              </div>
            )}
